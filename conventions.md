---
description: GeoEmbeddings core conventions for CRS (geo-proj), spatial transforms, and multiscale pyramids — composable, JSON Schema-validated, and built on the Zarr Conventions Framework.
---
